...
class GenericHTMLConverterTest extends TestCase
{
	public function testConvert() {
		...
		$htmlStr = $htmlConverter->convert($filePath, [
			...
			GenericHTMLConverter::MAIN_ICON_KEY => true,
		]);
